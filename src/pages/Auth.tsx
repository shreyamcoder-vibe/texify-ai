...
export default function AuthPage() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      toast({ title: "Account created!", description: "Welcome to Texify AI." });
      navigate("/app");
    }
  };
      ...
      <div className="flex items-center justify-center min-h-screen pt-20 px-4">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">Fix your messages before you send them</p>
          </div>
                  ...
                  <form onSubmit={handleSignUp} className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Input id="signup-name" type="text" placeholder="John Doe" value={fullName} onChange={(e) => setFullName(e.target.value)} className="pl-10" />
                      </div>
                    </div>
                    <div className="space-y-2">
